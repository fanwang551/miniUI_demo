...
namespace Plusoft.Web
{
    public class AjaxService : BaseService
    {
        ...
        public void SearchEmployees()
        {
            ...
            //业务层：数据库操作
            Hashtable result = new EmployeeBLL().SearchEmployeesResult(key, pageIndex, pageSize, sortField, sortOrder);
        ...
        public void RemoveEmployees()
        {
            ...
            new EmployeeBLL().Delete(id);            
        }
        public void GetEmployee()
        {
            String id = GetString("id");
            Hashtable user = new EmployeeBLL().GetEntity(id);
            RenderJson(user);
        }
        public void GetDepartments()
        {
            ArrayList data = new DepartmentBLL().GetList();
            RenderJson(data);
        }
        public void GetPositions()
        {
            ArrayList data = new PositionBLL().GetList();
            RenderJson(data);
        }
        public void GetEducationals()
        {
            ArrayList data = new EducationalBLL().GetList();
            RenderJson(data);
        }
        public void GetPositionsByDepartmenId()
        {
            String id = GetString("id");
            ArrayList data = new PositionBLL().GetPositionsByDepartmenId(id);
            RenderJson(data);
        }
        ...
        public void GetDepartmentEmployees()
        {
            ...
            Hashtable result = new EmployeeBLL().GetEmployeesByDeptIdResult(dept_id, pageIndex, pageSize);
            RenderJson(result);
        }
        ...
        //    {
        //        new EmployeeBLL().UpdateDepartment(d);
        //    }
        //}
        ...
        public void SearchEmployeesByMultiSort()
        {
            ...
            Hashtable result = new EmployeeBLL().SearchEmployeesResult(key, pageIndex, pageSize, sortFields);
